...
namespace Enkoni.Framework.DataAnnotations.Configuration {
  /// <summary>Defines the configuration element that can be used to configure the <see cref="EmailAttribute"/>.</summary>
  public class EmailValidationConfigElement : ConfigurationElement {
    #region Constructor
    /// <summary>Initializes a new instance of the <see cref="EmailValidationConfigElement"/> class.</summary>
    public EmailValidationConfigElement() {
    }
    #endregion

    #region Properties
    /// <summary>Gets or sets the name of the validator.</summary>
    [ConfigurationProperty("name", IsKey = true, IsRequired = false, DefaultValue = EmailAttribute.DefaultName)]
    public string Name {
