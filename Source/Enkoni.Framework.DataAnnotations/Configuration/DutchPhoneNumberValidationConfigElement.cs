...
namespace Enkoni.Framework.DataAnnotations.Configuration {
  /// <summary>Defines the configuration element that can be used to configure the <see cref="DutchPhoneNumberAttribute"/>.</summary>
  public class DutchPhoneNumberValidationConfigElement : ConfigurationElement {
    #region Constructor
    /// <summary>Initializes a new instance of the <see cref="DutchPhoneNumberValidationConfigElement"/> class.</summary>
    public DutchPhoneNumberValidationConfigElement() {
    ...
    [ConfigurationProperty("name", IsKey = true, IsRequired = false, DefaultValue = DutchPhoneNumberAttribute.DefaultName)]
    public string Name {
