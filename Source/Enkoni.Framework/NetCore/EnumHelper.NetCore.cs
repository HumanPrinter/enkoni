...
namespace Enkoni.Framework {
  ...
  public static partial class EnumHelper {
    ...
    public static string ToString(Enum enumValue, ResourceManager resources, CultureInfo culture) {
      ...
      LocalizedDescriptionAttribute localizedDescription = enumValueAsFieldInfo.GetCustomAttribute<LocalizedDescriptionAttribute>();
      if(localizedDescription != null) {
        ...
        string value = resources == null ? localizedDescription.DefaultDescription : resources.GetString(key, culture);
        if(value == null) {
        ...
        DescriptionAttribute description = enumValueAsFieldInfo.GetCustomAttribute<DescriptionAttribute>();
        if(description != null && !string.IsNullOrEmpty(description.Description)) {
          enumAsString = description.Description;
        }
        else {
          EnumMemberAttribute enumMember = enumValueAsFieldInfo.GetCustomAttribute<EnumMemberAttribute>();
          if(enumMember != null && !string.IsNullOrEmpty(enumMember.Value)) {
            enumAsString = enumMember.Value;
          }
        }
      }
