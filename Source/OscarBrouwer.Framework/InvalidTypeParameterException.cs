...
namespace OscarBrouwer.Framework {
  ...
  public class InvalidTypeParameterException : Exception {
    ...
    /// <summary> Initializes a new instance of the <see cref="InvalidTypeParameterException"/> class with a specified
    ...
    /// <summary>Initializes a new instance of the <see cref="InvalidTypeParameterException"/> class with serialized  
    /// data.</summary>
