...
namespace OscarBrouwer.Framework {
  ...
  internal class LambdaSpecification<T> : Specification<T> {
    #region Constructor
    /// <summary>Initializes a new instance of the <see cref="LambdaSpecification{T}"/> class that will always return
    /// <see langword="true"/>.</summary>
    internal LambdaSpecification()
    ...
    internal LambdaSpecification(Func<T, bool> function) {
