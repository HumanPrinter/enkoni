...
namespace Enkoni.Framework {
  ...
  public class NotSupportedTypeParameterException : Exception {
    ...
    /// <summary> Initializes a new instance of the <see cref="NotSupportedTypeParameterException"/> class with a 
    ...
    /// <summary>Initializes a new instance of the <see cref="NotSupportedTypeParameterException"/> class with 
