...
namespace Enkoni.Framework.Serialization {
  ...
  public sealed class CsvColumnAttribute : Attribute {
    ...
    /// <summary>Gets or sets the name of the culture that must be used to parse the field value. If this property is set,
    /// it overrides any culture-settings that may have been set in the CsvRecord-attribute.</summary>
