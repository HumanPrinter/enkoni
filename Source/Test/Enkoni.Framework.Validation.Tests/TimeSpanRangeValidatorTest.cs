...
namespace Enkoni.Framework.Validation.Tests {
  ...
  public class TimeSpanRangeValidatorTest {
    ...
    public void TestCase01_ValidValues() {
      ...
      EntLib.ValidationResults results = EntLib.Validation.Validate(dummyA, "ValidationTest");
      ...
      results = EntLib.Validation.Validate(dummyB, "ValidationTest");
      Assert.IsTrue(results.IsValid);
      ...
      results = EntLib.Validation.Validate(dummyC, "ValidationTest");
      Assert.IsTrue(results.IsValid);
    ...
    public void TestCase02_JustValidValues() {
      ...
      results = EntLib.Validation.Validate(dummyA, "ValidationTest");
      Assert.IsTrue(results.IsValid);
