...
namespace Enkoni.Framework.Entities.Tests {
  ...
  public class StaticMemoryRepositoryTest : RepositoryTest {
    ...
    [TestMethod]
    public void StaticMemoryRepository_FindAll_SpecificationWithMaxResultsLessThanAvailable_MaxResultsAreReturned() {
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
    ...
    /// <see cref="MemoryRepository{TEntity}"/> implementation.</summary>
    [TestMethod]
    public void StaticMemoryRepository_FindAll_SpecificationWithMaxResultsExactlyAvailable_AvailableRecordsAreReturned() {
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareSortingTests(store);
    ...
    /// <see cref="MemoryRepository{TEntity}"/> implementation.</summary>
    [TestMethod]
    public void StaticMemoryRepository_FindAll_SpecificationWithMaxResultsMoreThenAvailable_AvailableRecordsAreReturned() {
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareSortingTests(store);
    ...
    /// available.</summary>
    [TestMethod]
    public void StaticMemoryRepository_FindAll_CustomMappedType_AvailableRecordsAreReturned() {
      MemoryStore<CustomMappedTestDummy> store = new StaticMemoryStore<CustomMappedTestDummy>();
      PrepareSortingTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_FindFirstWithoutCloning_NoCopiesAreCreated() {
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareInputTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_FindFirstWithCloning_CopiesAreCreated() {
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareInputTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_Add_ItemIsStored() {
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
    ...
    /// implementation in combination with a <see cref="StaticMemoryStore{T}"/>.</summary>
    [TestMethod]
    public void StaticMemoryRepository_AddCustomMappedType_ItemIsStored() {
      MemoryStore<CustomMappedTestDummy> store = new StaticMemoryStore<CustomMappedTestDummy>();
      PrepareStorageTests(store);
    ...
    /// implementation in combination with a <see cref="StaticMemoryStore{T}"/>.</summary>
    [TestMethod]
    public void StaticMemoryRepository_Update_ItemIsUpdated() {
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// implementation in combination with a <see cref="StaticMemoryStore{T}"/>.</summary>
    [TestMethod]
    public void StaticMemoryRepository_UpdateCustomMappedType_ItemIsUpdated() {
      MemoryStore<CustomMappedTestDummy> store = new StaticMemoryStore<CustomMappedTestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_AddMultiple_ItemsAreAdded() {
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.AddEntities(IEnumerable{T})"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_AddMultipleCustomMappedTypes_ItemsAreAdded() {
      /* Create the repository */
      MemoryStore<CustomMappedTestDummy> store = new StaticMemoryStore<CustomMappedTestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_DeleteMultiple_ItemsAreDeleted() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_DeleteMultipleDeleteEntityTwice_OperationIsRolledBack() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_UpdateMultiple_ItemsAreUpdated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.UpdateEntities(IEnumerable{T})"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_UpdateMultipleCustomMappedTypes_ItemsAreUpdated() {
      /* Create the repository */
      MemoryStore<CustomMappedTestDummy> store = new StaticMemoryStore<CustomMappedTestDummy>();
      PrepareStorageTests(store);
    ...
    /// exception and rollback the operation.</summary>
    [TestMethod]
    public void StaticMemoryRepository_UpdateMultipleUpdateUnaddedEntity_OperationIsRolledBack() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_AddAndReset_AdditionIsUndone() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_UpdateAndReset_UpdateIsUndone() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_DeleteAndReset_DeletionIsUndone() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_AddWithoutCloning_NoCopyIsCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.AddEntity(T)"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_AddWithCloning_CopyIsCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.AddEntity(T)"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_AddDeletedItemWithoutCloning_NoCopyIsCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.AddEntity(T)"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_AddDeletedItemWithCloning_CopyIsCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.AddEntities(IEnumerable{T})"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_AddMultipleWithoutCloning_NoCopiesAreCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.AddEntities(IEnumerable{T})"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_AddMultipleWithCloning_CopiesAreCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_UpdateWithoutCloning_NoCopyIsCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.UpdateEntity(T)"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_UpdateWithCloning_CopyIsCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.UpdateEntities(IEnumerable{T})"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_UpdateMultipleWithoutCloning_NoCopiesAreCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    /// <summary>Tests the functionality of the <see cref="Repository{T}.UpdateEntities(IEnumerable{T})"/> method.</summary>
    [TestMethod]
    public void StaticMemoryRepository_UpdateMultipleWithCloning_CopiesAreCreated() {
      /* Create the repository */
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    [TestMethod]
    public void StaticMemoryRepository_ExecuteWithDefaultSpecification_NullIsReturned() {
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
    ...
    public void StaticMemoryRepository_ExecuteWithBusinessRule_ExceptionIsThrown() {
      MemoryStore<TestDummy> store = new StaticMemoryStore<TestDummy>();
      PrepareStorageTests(store);
