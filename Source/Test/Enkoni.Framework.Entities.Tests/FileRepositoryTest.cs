//---------------------------------------------------------------------------------------------------------------------------------------------------
// <copyright file="FileRepositoryTest.cs" company="Oscar Brouwer">
//     Copyright (c) Oscar Brouwer 2011. All rights reserved.
// </copyright>
// <summary>
//     Contains testcases that test the functionality of the FileRepository class.
// </summary>
//---------------------------------------------------------------------------------------------------------------------------------------------------
...
namespace Enkoni.Framework.Entities.Tests {
	...
	public abstract class FileRepositoryTest : RepositoryTest {
		...
		public abstract void TestCase28_ReadFile();
		...
		public abstract void TestCase29_ReadEmptyFile();
		#endregion
		...
		/// method.</summary>
		public abstract void TestCase30_WriteFile();

		/// <summary>Tests the functionality of the <see cref="XmlFileRepository{T}.WriteAllRecordsToFile(FileInfo,DataSourceInfo,IEnumerable{T})"/> 
		/// method when writing an empty file.</summary>
		public abstract void TestCase31_WriteEmptyFile();
		#endregion
