...
namespace Enkoni.Framework.Entities {
  ...
  public abstract class FileRepository<TEntity> : Repository<TEntity>
    ...
    /// <summary>Adds a new entity to the repository. It is added to the addition cache untill it is saved using the <see cref="M:SaveChanges()"/> 
    /// method. A temporary (negative) RecordID is assigned to the entity. This will be reset when the entity is saved.</summary>
    ...
    /// to the deletion-cache untill it is saved using the <see cref="M:SaveChanges()"/> method.</summary>
    ...
    /// <see cref="M:PauseSourceFileMonitor()"/> method, however since the filemonitor does not have any specific pause/resume behaviour, calling 
    /// this method is the same as calling <see cref="M:StartSourceFileMonitor()"/>.</summary>
    ...
    /// <see cref="M:ResumeSourceFileMonitor()"/> method, however since the filemonitor does not have any specific pause/resume behaviour, calling 
    /// this method is the same as calling <see cref="M:StopSourceFileMonitor()"/>.</summary>
