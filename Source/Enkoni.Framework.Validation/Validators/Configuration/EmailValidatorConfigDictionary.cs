//---------------------------------------------------------------------------------------------------------------------------------------------------
// <copyright file="EmailValidatorConfigDictionary.cs" company="Oscar Brouwer">
//     Copyright (c) Oscar Brouwer 2013. All rights reserved.
// </copyright>
// <summary>
//     Contains a custom dictionary that holds multiple EmailValidatorConfigElement instances.
// </summary>
//---------------------------------------------------------------------------------------------------------------------------------------------------
...
namespace Enkoni.Framework.Validation.Validators.Configuration {
  /// <summary>Defines a custom dictionary that holds the <see cref="EmailValidatorConfigElement"/> that were read from the configuration 
  /// file.</summary>
  public class EmailValidatorConfigDictionary : IDictionary<string, EmailValidatorConfigElement> {
    #region Instance variables
    /// <summary>The actual storage.</summary>
    private Dictionary<string, EmailValidatorConfigElement> storage;
    #endregion

    #region Constructor
    /// <summary>Initializes a new instance of the <see cref="EmailValidatorConfigDictionary"/> class.</summary>
    public EmailValidatorConfigDictionary() {
      this.storage = new Dictionary<string, EmailValidatorConfigElement>();
    }
    #endregion
    ...
    public ICollection<EmailValidatorConfigElement> Values {
    ...
    public EmailValidatorConfigElement this[string key] {
      get {
        if(this.storage.ContainsKey(key)) {
          return this.storage[key];
        }
        else if(this.storage.ContainsKey(EmailValidator.DefaultName)) {
          return this.storage[EmailValidator.DefaultName];
        }
        else {
          return null;
        }
    ...
    public void Add(string key, EmailValidatorConfigElement value) {
      this.storage.Add(key, value);
    }

    /// <summary>Adds an item to the <see cref="ICollection{T}"/>.</summary>
    /// <param name="item">The object to add to the <see cref="ICollection{T}"/>.</param>
    public void Add(KeyValuePair<string, EmailValidatorConfigElement> item) {
      ((IDictionary<string, EmailValidatorConfigElement>)this.storage).Add(item);
    }
    ...
    public bool Contains(KeyValuePair<string, EmailValidatorConfigElement> item) {
    ...
    public bool Remove(KeyValuePair<string, EmailValidatorConfigElement> item) {
      return ((IDictionary<string, EmailValidatorConfigElement>)this.storage).Remove(item);
    }
    ...
    /// <exception cref="ArgumentNullException"><paramref name="key"/> is <see langword="null"/>.</exception>
    public bool TryGetValue(string key, out EmailValidatorConfigElement value) {
    ...
    public void CopyTo(KeyValuePair<string, EmailValidatorConfigElement>[] array, int arrayIndex) {
      ((IDictionary<string, EmailValidatorConfigElement>)this.storage).CopyTo(array, arrayIndex);
    }

    /// <summary>Returns an enumerator that iterates through the collection.</summary>
    /// <returns>A <see cref="IEnumerator{T}"/> that can be used to iterate through the collection.</returns>
    public IEnumerator<KeyValuePair<string, EmailValidatorConfigElement>> GetEnumerator() {
